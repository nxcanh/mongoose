...
Model.find = function find (conditions, fields, options, callback) {
  ...
  conditions = alias_conditions(this, conditions);
  fields = alias_conditions(this, fields);
  options = alias_conditions(this, options);
...
/**
 * Modify the conditions regarding the alias mappings
 *
 * @param {Function} This model
 * @param {String} conditions
 * @return {String}
 */
function alias_conditions(self, conditions) {
  ...
  for (var path in schema.paths) {
    if (schema.paths[path].options.alias && 'string' == typeof schema.paths[path].options.alias && schema.paths[path].options.alias != '') {
      ...
      json = json.replace(new RegExp('"' + aliased_property + '"', 'g'), '"' + real_property + '"');
    }
  }
